...
class ArztterminSkill(MycroftSkill):
    ...
    def add_unspecified_reminder(self, msg=None):        
        # TIME:
        time_response = self.get_response('ParticularTime', on_fail='wait.for.answer', num_retries=-1)
        ...
        months = ['januar', 'februar','märz', 'april', 'mai', 'juni', 'juli', 'august', 'september','oktober','november','dezember','januar.', 'februar.','märz.', 'april.', 'mai.', 'juni.', 'juli.', 'august.', 'september.','oktober.','november.','dezember.']
        ...
        name = self.get_response('ParticularName', on_fail='wait.for.answer', num_retries=-1)
